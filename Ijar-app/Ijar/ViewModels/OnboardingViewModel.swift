...
class OnboardingViewModel: ObservableObject {
    ...
    func completeOnboarding() async -> [Property] {
        ...
        do {
            // 1. Create SearchQuery with a specific ID we can reference
            ...
            // 3. Fetch initial properties using onboarding endpoint (saves to Supabase)
