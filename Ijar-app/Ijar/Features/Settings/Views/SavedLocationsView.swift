...
struct SavedLocationsView: View {
    ...
    var body: some View {
        VStack(spacing: 0) {
            ...
            if locationsManager.locations.isEmpty {
                ...
                VStack(spacing: 16) {
                    ...
                    Button(action: { viewModel.handleAddLocation(currentLocationCount: locationsManager.locations.count) }) {
                        Text("Add a place")
                    ...
                    VStack(spacing: 0) {
                        ForEach(Array(locationsManager.locations.enumerated()), id: \.element.id) { index, location in
                            SavedLocationCard(
                                location: location,
                                onEdit: {
                                    viewModel.locationToEdit = location
                                },
                                onDelete: {
        ...
        .sheet(item: $viewModel.locationToEdit) { location in
